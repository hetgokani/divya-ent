    ...
    >
      ...
      >
        ...
        <div className="header-block" style={{ marginBottom: "60px" }}>
          ...
          >
            ROAD & <br />
            <span className="outline-text">CIVIL</span> <br />
            INFRASTRUCTURE
          </motion.h1>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Divya Enterprise undertakes massive{" "}
              <strong style={{ color: theme.navyBlue }}>
                civil infrastructure development projects
              </strong>{" "}
              including heavy-duty roads, public utility networks, and
              comprehensive urban development solutions.
            </p>
            ...
            >
              We contribute directly to regional infrastructure growth through
              premium quality road construction, public utility works, advanced
              drainage systems, and urban civil engineering projects. Every
              project is meticulously designed and executed for long-term public
              benefit and durability.
            </p>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <img
                src={roadImg}
                alt="Road construction and civil infrastructure"
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "cover",
              ...
              >
                <span>Paving The Path Forward</span>
                <div
                  style={{
                    height: "2px",
                    width: "30px",
