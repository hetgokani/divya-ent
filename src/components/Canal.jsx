...
import canalImg from "../assets/s2.webp";
    ...
    >
      ...
      >
        ...
        <div className="header-block" style={{ marginBottom: "60px" }}>
          ...
          >
            CANAL & <br />
            <span className="outline-text">IRRIGATION</span> <br />
            PROJECTS
          </motion.h1>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Agricultural Growth & Conservation
            </h3>
            ...
            >
              Divya Global Infra Ltd. undertakes{" "}
              <strong style={{ color: theme.navyBlue }}>
                canal construction, canal lining, and irrigation development
                projects
              </strong>{" "}
              that support robust agricultural growth and sustainable water
            ...
            >
              We have successfully completed multiple complex canal and
              irrigation projects under critical government schemes such as
              PMKSY and Narmada projects. Our expertise ensures improved water
              accessibility and maximized agricultural productivity for the
              region.
            </p>
            ...
            >
              ...
              >
                {[
                  "RCC Canal Lining",
                  "Groundwater Systems",
                  "Pumping Irrigation Works",
                  "PMKSY Implementations",
                  "Narmada Project Works",
                  "Water Conservation",
                ].map((item, index) => (
                  <li
                    key={index}
          ...
          <div style={{ position: "relative", height: "fit-content" }}>
            ...
            >
              <img
                src={canalImg}
                alt="Massive irrigation canal construction project"
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "cover",
