    ...
    >
      ...
      >
        ...
        <div className="header-block" style={{ marginBottom: "60px" }}>
          ...
          >
            WATER TREATMENT <br />
            <span className="outline-text">PLANT</span> <br />
            PROJECTS
          </motion.h1>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Clean & Sustainable Distribution
            </h3>
            ...
            >
              Divya Global Infra Ltd. develops modern{" "}
              <strong style={{ color: theme.navyBlue }}>
                water treatment infrastructure
              </strong>{" "}
              designed for clean and sustainable water distribution systems.
            </p>
            ...
            >
              We construct advanced water treatment plants (WTP) including
              comprehensive intake systems, advanced filtration units,
              heavy-duty pumping stations, and large-scale storage facilities.
              Our projects help provide safe, reliable drinking water solutions
          ...
          <div style={{ position: "relative", height: "fit-content" }}>
            ...
            >
              <img
                src={wtpImg}
                alt="Modern water treatment plant facility"
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "cover",
              ...
              >
                <span>Purifying For The Future</span>
                <div
                  style={{
                    height: "2px",
                    width: "30px",
